...
(function () {
    'use strict';
    angular.module('app.charts').controller('ChartistController', ChartistController);
                    ...
                    if (data.type === 'line') {
                        ...
                        data.element.animate({
                            opacity: {
                                ...
                                begin: seq * delays + 1000, // Duration of the animation
                                dur: durations, // The value where the animation should start
                                from: 0, // The value where it should end
                                to: 1
                            }
                        });
                    }
                        ...
                        data.element.animate({
                            y: {
                                ...
                                , dur: durations
                                , from: data.y + 100
                                , to: data.y, // We can specify an easing function from Chartist.Svg.Easing
                                easing: 'easeOutQuart'
                            }
                        });
                    }
...
(function () {
    'use strict';
    angular.module('app.charts').controller('ChartJSController', ChartJSController);
...
(function () {
    ...
    angular.module('app.charts')
        ...
        .directive('linechart', chartJS('Line')).directive('barchart', chartJS('Bar')).directive('radarchart', chartJS('Radar')).directive('polarchart', chartJS('PolarArea')).directive('piechart', chartJS('Pie')).directive('doughnutchart', chartJS('Doughnut')).directive('donutchart', chartJS('Doughnut'));
            ...
            return {
                ...
                , link: function ($scope, $elem) {
                    ...
                    $scope.$watch('data', function (newVal) {
                        ...
                        if ($scope.responsive || $scope.resize) $scope.options.responsive = true;
                        if ($scope.responsive !== undefined) $scope.options.responsive = $scope.responsive;
                        chartCreated = chart[type]($scope.data, $scope.options);
                        chartCreated.update();
                        if ($scope.legend) angular.element($elem[0]).parent().after(chartCreated.generateLegend());
                    }, true);
                    $scope.$watch('tooltip', function (newVal) {
                        if (chartCreated) chartCreated.draw();
                        if (newVal === undefined || !chartCreated.segments) return;
                        if (!isFinite(newVal) || newVal >= chartCreated.segments.length || newVal < 0) return;
...
(function () {
    'use strict';
    angular.module('app.charts').directive('classyloader', classyloader);
...
(function () {
    'use strict';
    angular.module('app.charts').service('ChartData', ChartData);
...
(function () {
    'use strict';
    angular.module('app.charts').controller('FlotChartController', FlotChartController);
...
(function () {
    'use strict';
    angular.module('app.charts').directive('flot', flot);
        ...
        function link(scope, element, attrs) {
            ...
            function onSerieToggled(series) {
                ...
                function toggleFor(sName) {
                    return function (s, i) {
                        if (someData[i] && someData[i][sName]) someData[i][sName].show = s;
                    };
                }
            }
...
(function () {
    'use strict';
    angular.module('app.charts').controller('ChartMorrisController', ChartMorrisController);
...
(function () {
    'use strict';
    angular.module('app.charts').directive('morrisBar', morrisChart('Bar')).directive('morrisDonut', morrisChart('Donut')).directive('morrisLine', morrisChart('Line')).directive('morrisArea', morrisChart('Area'));
        ...
        return function () {
            return {
                ...
                , link: function ($scope, element) {
                    ...
                    if ($scope.morrisData) $scope.morrisOptions.data = $scope.morrisData;
                    // Init chart
...
(function () {
    'use strict';
    angular.module('app.charts').controller('PieChartsController', PieChartsController);
    /*jshint -W069*/
...
(function () {
    'use strict';
    angular.module('app.charts').controller('ChartRickshawController', ChartRickshawController);
...
(function () {
    'use strict';
    angular.module('app.charts').directive('sparkline', sparkline);
...
(function () {
    'use strict';
    angular.module('app.dashboard').controller('DashboardV2Controller', DashboardV2Controller);
    ...
    function DashboardV2Controller($rootScope, $scope, $state) {
        ...
        function activate() {
            ...
            if ($state.includes('app-h')) {
                ...
                if (!$rootScope.app.layout.isCollapsedText) $rootScope.app.layout.isCollapsed = true;
            }
            // BAR STACKED
            // -----------------------------------
            vm.barStackedOptions = {
...
(function () {
    'use strict';
    angular.module('app.elements').controller('AngularCarouselController', AngularCarouselController);
...
(function () {
    'use strict';
    angular.module('app.elements').controller('DialogIntroCtrl', DialogIntroCtrl).controller('DialogMainCtrl', DialogMainCtrl).controller('InsideCtrl', InsideCtrl).controller('SecondModalCtrl', SecondModalCtrl);
...
(function () {
    'use strict';
    angular.module('app.elements').controller('InfiniteScrollController', InfiniteScrollController).factory('datasource', datasource);
...
(function () {
    'use strict';
    angular.module('app.elements').controller('MasonryDeckController', MasonryDeckController).directive('imageloaded', imageloaded); // required by demo
...
(function () {
    'use strict';
    angular.module('app.elements').controller('AbnTestController', AbnTestController);
...
(function () {
    'use strict';
    angular.module('app.elements').controller('NestableController', NestableController);
...
(function () {
    'use strict';
    angular.module('app.elements').directive('scrollable', scrollable);
...
(function () {
    'use strict';
    angular.module('app.elements').controller('SortableController', SortableController);
...
(function () {
    'use strict';
    angular.module('app.elements').controller('SweetAlertController', SweetAlertController);
...
(function () {
    'use strict';
    angular.module('app.elements').controller('ToasterDemoCtrl', ToasterDemoCtrl);
...
(function () {
    'use strict';
    angular.module('app.elements').controller('TourCtrl', TourCtrl);
...
(function () {
    'use strict';
    angular.module('app.extras').controller('ArticleController', ArticleController);
...
(function () {
    'use strict';
    angular.module('app.extras').controller('CalendarController', CalendarController);
...
(function () {
    'use strict';
    angular.module('app.extras').service('LoadTreeService', LoadTreeService);
...
(function () {
    'use strict';
    angular.module('app.extras').controller('CodeEditorController', CodeEditorController);
    ...
    function CodeEditorController($rootScope, $scope, $http, $ocLazyLoad, filetree) {
        ...
        function activate() {
            ...
            vm.handle_filetree = function (branch) {
                ...
                if (!isFolder) {
                    $http.get(basePath + branch.path).success(function (response) {
...
(function () {
    'use strict';
    angular.module('app.extras').controller('TodoController', TodoController);
...
(function () {
    'use strict';
    angular.module('app.extras').controller('WordCloudController', WordCloudController);
...
(function () {
    'use strict';
    angular.module('app.flatdoc').directive('flatdoc', flatdoc);
...
(function () {
    'use strict';
    angular.module('app.forms').controller('ColorPickerController', ColorPickerController);
...
(function () {
    'use strict';
    angular.module('app.forms').directive('filestyle', filestyle);
...
(function () {
    'use strict';
    angular.module('app.forms').controller('ImageCropController', ImageCropController);
...
(function () {
    'use strict';
    angular.module('app.forms').controller('FormValidationController', FormValidationController);
...
(function () {
    'use strict';
    angular.module('app.forms').directive('formWizard', formWizard);
                ...
                if (angular.isDefined(self.steps[step])) {
                    if (self.validate && step !== 1) { // no need to validate when move to first state
                        ...
                        if (typeof scope.wizardValidate === 'function') {
                            ...
                            if (!scope.wizardValidate(form.attr('ng-form'))) return false;
                        }
                    }
                    self.cleanall();
...
(function () {
    'use strict';
    angular.module('app.forms').controller('FormxEditableController', FormxEditableController);
...
(function () {
    'use strict';
    angular.module('app.forms').controller('FormDemoCtrl', FormDemoCtrl);
...
(function () {
    'use strict';
    angular.module('app.forms').directive('masked', masked);
...
(function () {
    'use strict';
    angular.module('app.forms').filter('propsFilter', propsFilter);
...
(function () {
    'use strict';
    angular.module('app.forms').directive('tagsinput', tagsinput);
...
(function () {
    'use strict';
    angular.module('app.forms').controller('uiSelectController', uiSelectController);
    ...
    angular.module('app.lazyload').constant('APP_REQUIRES', {
        ...
        scripts: {
            ...
            , 'codemirror': ['vendor/codemirror/lib/codemirror.js'
                                   , 'vendor/codemirror/lib/codemirror.css'], // modes for common web files
...
(function () {
    'use strict';
    angular.module('app.mailbox').controller('MailboxController', MailboxController);
...
(function () {
    'use strict';
    angular.module('app.mailbox').controller('MailFolderController', MailFolderController);
...
(function () {
    'use strict';
    angular.module('app.mailbox').factory('mails', mails);
    mails.$inject = ['$http'];
...
(function () {
    'use strict';
    angular.module('app.mailbox').controller('MailViewController', MailViewController);
...
(function () {
    'use strict';
    angular.module('app.maps').controller('ModalGmapController', ModalGmapController);
...
(function () {
    'use strict';
    angular.module('app.maps').controller('GMapController', GMapController);
...
(function () {
    'use strict';
    angular.module('app.maps').directive('vectorMap', vectorMap);
...
(function () {
    'use strict';
    angular.module('app.maps').service('VectorMap', VectorMap);
...
(function () {
    'use strict';
    angular.module('app.maps').controller('VectorMapController', VectorMapController);
...
(function () {
    'use strict';
    angular.module('app.navsearch').directive('searchOpen', searchOpen).directive('searchDismiss', searchDismiss);
    //
...
(function () {
    'use strict';
    angular.module('app.notify').controller('NotifyDemoCtrl', NotifyDemoCtrl);
    ...
    function NotifyDemoCtrl(Notify, $timeout) {
        ...
        function activate() {
            ...
            $timeout(function () {
                Notify.alert('This is a custom message from notify..', {
                    status: 'success'
                });
            }, 500);
        }
...
(function () {
    'use strict';
    angular.module('app.pages').controller('RegisterFormController', RegisterFormController);
...
(function () {
    'use strict';
    angular.module('app.panels').directive('panelCollapse', panelCollapse);
...
(function () {
    'use strict';
    angular.module('app.panels').directive('panelDismiss', panelDismiss);
...
(function () {
    'use strict';
    angular.module('app.panels').directive('panelRefresh', panelRefresh);
...
(function () {
    'use strict';
    angular.module('app.panels').directive('paneltool', paneltool);
...
(function () {
    'use strict';
    angular.module('app.panels').controller('PanelsCtrl', PanelsCtrl);
...
(function () {
    'use strict';
    angular.module('app.panels').controller('DraggablePanelController', DraggablePanelController);
...
(function () {
    ...
    function settingsRun($rootScope, $localStorage) {
        ...
        // -----------------------------------
        $rootScope.app = {
            name: 'Social Commerce - Admin'
            , description: 'Social Commerce System'
...
(function () {
    'use strict';
    angular.module('app.tables').controller('AngularGridController', AngularGridController);
...
/**=========================================================
 * Module: datatable,js
 * Angular Label Datatable controller
 =========================================================*/
(function () {
    'use strict';
    angular.module('app.tables').controller('LabelDataTableController', LabelDataTableController);
    LabelDataTableController.$inject = ['$resource', 'DTOptionsBuilder', 'DTColumnDefBuilder'];

    function LabelDataTableController($resource, DTOptionsBuilder, DTColumnDefBuilder) {
        var vm = this;
        activate();
        ////////////////
        function activate() {
...
(function () {
    'use strict';
    angular.module('app.tables').controller('DataTableController', DataTableController);
...
(function () {
    'use strict';
    angular.module('app.tables').service('ngTableDataService', ngTableDataService);
...
(function () {
    'use strict';
    angular.module('app.tables').controller('NGTableCtrl', NGTableCtrl);
    /*jshint -W055 */
...
(function () {
    'use strict';
    angular.module('app.tables').controller('TablexEditableController', TablexEditableController);
...
(function () {
    'use strict';
    angular.module('app.tables').controller('UIGridController', UIGridController);
    ...
    function UIGridController(uiGridConstants, $http) {
        ...
        function activate() {
            ...
            $http.get('server/uigrid-complex.json').success(function (data) {
            ...
            $http.get('server/uigrid-100.json').success(function (data) {
...
(function () {
    'use strict';
    angular.module('custom').controller('Controller', Controller);
...
(function () {
    'use strict';
    angular.module('app.bootstrapui').controller('AdminDashboardController', AdminDashboardController);
    AdminDashboardController.$inject = ['$http'];

    function AdminDashboardController($http) {
        var vm = this;
        vm.AdminAppFlow =  function($http) {
            var path = 'http://localhost:3002/admin';
            return $http.get(path).then(function (resp) {
                console.log(resp.data[0].Flow.PageName)
                vm.AdminMaster = resp.data;
            });
        }
        vm.AdminAppFlow($http);
        /*vm.AdminMaster = {
            Applications: [{
                AppID: 1
                , AppName: "Supplier"
        ...
        vm.adminSelection = {
            AppName: "Please select"
            , PageName: "Please select"
            , StepName: "Please select"
            , VersionName: "Please select"
            , StatusName: "Please select"
            , LanguageName: "Please select"
        };
        vm.SetSelection = function (ival, itoken) {
            if (itoken == 'AppName') vm.adminSelection.AppName = ival;
            else if (itoken == 'PageName') vm.adminSelection.PageName = ival;
            else if (itoken == 'StepName') vm.adminSelection.StepName = ival;
            else if (itoken == 'VersionName') vm.adminSelection.VersionName = ival;
            else if (itoken == 'StatusName') vm.adminSelection.StatusName = ival;
            else if (itoken == 'LanguageName') vm.adminSelection.LanguageName = ival;
        }
    }
})();
